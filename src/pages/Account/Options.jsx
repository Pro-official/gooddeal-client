...
const Options = () => {
	return (
		<div className='shadow-xl max-w-7xl mx-auto mt-10 mb-10 pb-10'>
			<div className='sm:flex flex-wrap justify-center items-center text-center gap-2'>
				<Link
				...
				>
					<div>
						...
						<p className='text-md  text-gray-500 dark:text-gray-300 py-4'>
							...
							solutions for digital increase for your business.
						</p>
					</div>
				</Link>
			</div>
